...
output "E_02_ip_addresses" {
  value = data.confluent_ip_addresses.main.ip_addresses
}


output "F_01_integration_id" {
  value = resource.confluent_provider_integration.main.id
}

output "F_02_integration_aws" {
  value = resource.confluent_provider_integration.main.aws
}
